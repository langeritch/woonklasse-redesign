...
const CITIES = [
  ...
  { slug: 'amersfoort',         name: 'Amersfoort',         wijken: ['Centrum', 'Soesterkwartier', 'Vathorst', 'Schothorst'],          nearby: ['utrecht', 'zeist', 'hilversum', 'ede'],                       positioning: 'Van karakterwoningen in het Soesterkwartier tot ruime gezinshuizen in Vathorst, onze ploeg rijdt vanuit Amsterdam-Duivendrecht zonder reiskosten naar je toe.' },
  ...
  { slug: 'amstelveen',         name: 'Amstelveen',         wijken: ['Centrum', 'Westwijk', 'Buitenveldert', 'Bovenkerk'],              nearby: ['amsterdam', 'haarlemmermeer', 'haarlem', 'zaanstad'],         positioning: 'Amstelveense gezinswoningen vragen om strakke uitvoering en oog voor detail. Onze ploeg rijdt vanuit Amsterdam-Duivendrecht naar je toe, zonder reiskosten.' },
  ...
  <div class="footer__inner">
    ...
    <div class="footer__cols">
      ...
      <div>
        ...
        <span>Joop Geesinkweg 201<br/>1114 AB Amsterdam-Duivendrecht</span>
      </div>
      <div>
